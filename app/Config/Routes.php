...
$routes->get('/e_magazine', 'User\HomeController::e_magazine');
$routes->get('/galeri_fhci', 'User\HomeController::galeri_fhci');
$routes->get('/kontak', 'User\HomeController::kontak');
