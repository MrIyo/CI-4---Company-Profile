  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <div class="logo me-auto">
        <h1><a href="index.html"><img src="Lumia/assets/img/FHCI.png" alt="" class="img-fluid"></a></h1>
      </div>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="/program_event">Program & Event</a></li>
          <li class="dropdown"><a href="#"><span>Meida Center</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="/siaran_pers">SIARAN PERS</a></li>
              <li><a href="/artikel">ARTIKEL</a></li>
              <li><a href="/e_magazine">E MAGAZINE</a></li>
              <li><a href="/galeri_fhci">GALERI FHCI</a></li>
            </ul>
          </li>
...
<div class="container">
  <div class="copyright">
    &copy; 2019 by <strong><a href="http://fhcibumn.com/">Forum Human Capital Indonesia.</a></strong>. All Rights Reserved
  </div>
  <div class="credits">
